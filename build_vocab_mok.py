...
def main(args):
    vocab_idx2word, vocab_word2idx = build_vocab(json=args.caption_path, threshold=args.threshold)
    vocab_idx2word_json = json.dumps(vocab_idx2word)
    vocab_word2idx_json = json.dumps(vocab_word2idx)
